...
/**
 * define a task to generate a runable script for qshield service
...
/**
 * define baseDirectory used in rest
...
/**
 * define a task to clean up build files generated in rest project
 * @return None
 */
